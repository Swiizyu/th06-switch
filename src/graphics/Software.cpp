...
#else
    (void)g_Supervisor.cfg.windowed;
#endif
...
void Software::SwapBuffers()
{
    ...
    SDL_Rect dstRect = {(int)VIEWPORT_OFF_X, (int)VIEWPORT_OFF_Y, (int)VIEWPORT_WIDTH, (int)VIEWPORT_HEIGHT};
    SDL_RenderCopy(renderer, framebufferTexture, NULL, &dstRect);
#else
